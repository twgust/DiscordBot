...
public class LastFmRecentTracksParser {
    ...
    public LastFmRecentTracksParser(String apikey, String username, int trackamount){
        ...
        client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                ...
                .thenAccept(LastFmRecentTracksParser::parse)
                .join();
    ...
    public static String[][] getResultsRecents() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.deepToString(LastFmRecentTracksParser.resultsRecents));
    }
}
